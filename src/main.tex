...
\begin{document}
\input{basics.tex}\clearpage
\input{distributions.tex}\clearpage
\input{exp_var.tex}\clearpage
\input{zipf.tex}\clearpage
\input{correlation.tex}\clearpage
\input{computations.tex}\clearpage
\input{moments.tex}\clearpage
\input{distances.tex}\clearpage
\input{lln_clthm.tex}\clearpage
\input{summaries.tex}
\end{document}